  ...
  return function (target, name, descriptor) {
    try {
      ...
      descriptor.value = async (...args) => {
        ...
        const currencyRate = await (0, _axios.default)(`https://free.currencyconverterapi.com/api/v6/convert?q=${to.toUpperCase()}_${base.toUpperCase()}&compact=y&apiKey=${process.env.CURRENCY_CONVERTER_API_KEY}`);
...
let Cost = (_dec = (0, _CurrencyConverter.default)("NGN", "USD"), (_class = class Cost {
  compute(qty, price) {
